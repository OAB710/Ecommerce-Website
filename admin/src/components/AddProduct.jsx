...
const Add_Product = async () => {
 ...
 <div className="mb-3 flex items-center gap-x-4">
  ...
  <select name="category" id="" className="bg-primary ring-1 ring-slate-900/20 medium-16 rounded-sm outline-none" value={productDetails.category} onChange={changeHandler}>
