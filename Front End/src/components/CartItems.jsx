...
import { ShopContext } from "../Context/ShopContext"; // Assuming ShopContext is defined in ShopContext.js
import { TbTrash } from "react-icons/tb"; // Assuming you are using react-icons
      ...
      <table className="w-full mx-auto">
        ...
        <tbody>
          {all_products.map((e) => {
            ...
            return null; // or you can simply omit this line
          })}
        </tbody>
      </table>
