  ...
  return (
    <section className='relative bg-hero bg-cover bg-center bg-no-repeat h-screen w-full pb-12 '>
        <div className='max_padd_container relative top-32 xs:top-52'>
            <h1 className='h1 capitalize max-w-[37rem]' >Ecommerce Clothes Store</h1>
            ...
            <div className="bold-16 sm:bold-20"><span className="regular-16 sm:regular-20">Excellent Reviews</span>
            </div>
